...
The presenting author should be registered for the second workshop day (September 22) of the MICCAI conference. Via [pathable](https://miccai2022.pathable.eu/), the DALI workshop event can be added to your agenda. A zoom link to join the event will become available in pathable, shortly before the start of the event (8:00am SGT on Sep. 22). All virtual attendees should join the event via the zoom link provided in pathable. 
