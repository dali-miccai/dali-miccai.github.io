...
The presenting author should be registered for the second workshop day (September 22) of the MICCAI conference. Via [pathable](https://miccai2022.pathable.eu/), the DALI workshop event can be added to your agenda, and the zoom link to join the event will be available in pathable. All presenters and attendees joining remotely will also join the event via the link provided in pathable. 
